...
const mocks = new Map(Object.entries({
    ...
    'src/communication/chat/services/chat-content.js': `export const cleanMessage=String; export const messageContentHtml=value=>esc(value); export const esc=value=>String(value??'').replaceAll('&','&amp;').replaceAll('<','&lt;').replaceAll('"','&quot;');`,
